...
namespace OrchX
{
    ...
    public static class CommandManager
    {
        ...
        static CommandManager()
        {
            ...
            {
                shouldExit = false;
                OrchX.Tools.MockDataManager.IsRecordingMockData = !OrchX.Tools.MockDataManager.IsRecordingMockData;
                string status = OrchX.Tools.MockDataManager.IsRecordingMockData ? "ON" : "OFF";
                Console.ForegroundColor = ConsoleColor.Cyan;
        ...
        /// </summary>
        private static void DisplayChatHistory(ReadOnlyCollection<object> chatHistory, OrchX.AIClient.IAIClient client)
        {
